...
def parse_args():
    ...
    # Checkpointing
    parser.add_argument("--exp-name", type=str, default="baseline", help="name of the experiment")
    parser.add_argument("--save-dir", type=str, default="./policies/", help="directory in which training state and model should be saved")
